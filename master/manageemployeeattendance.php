   ...
   <section class="content">
      <div class="container-fluid">
                           ...
                           <div class="row">
                              <div class="col-sm-4">
                               ...
                               <div class="col-sm-4" id="logindiv">
                                 <div class="form-group">
                                    <label for="email">Login Time <font color="red">*</font></label>
                                ...
                                <div class="col-sm-4" id="logoutdiv">
                                 <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" id="logout_time" name="logout_time" readonly value=<?php echo date("h:i a"); ?> />
                                 </div>
                              </div>
         ...
         <div id="mlist">
            <div class="card card-info">
               <div class="card-header">
                  <h3 class="card-title">List of Employee Attendance</h3>
               </div>
               <div class="card-body">
   ...
   var user_id = '<?php echo $_SESSION['user_id']; ?>';
      $.ajax({
         ...
         data: {tableSql: "SELECT attendance_id , attendance_user_name as Name,DATE_FORMAT(attendance_date,'%d/%m/%Y') as Date,login_time,logout_time, project_name " +
                    " FROM attendance inner join project on attendance_project_id = project_id where attendance_type = 1 ORDER BY attendance_id desc ",
