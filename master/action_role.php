         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Role Action</li>
               </ol>
            </div>
         </div>
      </div><!-- /.container-fluid -->
   ...
   <section class="content">
      <div class="container-fluid">
         ...
         <div id="madd">
            <div class="card card-info">
               <div class="card-header">
                  <h3 class="card-title">Role Action</h3>
               </div>
               <form class="form-horizontal"id="add_form">

                  <input type="hidden" id="action" name="action" value="add"/>
                  <input type="hidden" class="form-control" id="rr_id" name="rr_id"/>
                  <div class="card-body">
         ...
         <div id="mlist">
            <div class="card card-info">
               <div class="card-header">
                  <h3 class="card-title">List of Role Action</h3>
...
<script>
   ...
   function ongetPage(pageNo) {
      $.ajax({
         ...
         type: "POST",
         data: {tableSql: "SELECT * from role_action ORDER BY rr_id desc "
