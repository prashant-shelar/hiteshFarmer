...
if( !empty($data->attendance_user_id) && !empty($data->action)){
    ...
    $sqlcheck = "select * from attendance where attendance_date = CURDATE() and  attendance_type = 1 and attendance_user_id =".$data->attendance_user_id;
    $result = $conn->query($sqlcheck);
    $requestDate['attendance_flag'] = "Y"; 
    $requestDate['attendance_type'] = "1"; 
